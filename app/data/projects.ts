...
export const projects: Project[] = [
  {
    ...
    technologies: ['React.js', 'Material UI', 'Redux Toolkit', 'Node.js', 'Express.js', 'Parse Server', 'Java SpringBoot', 'PostgreSQL', 'Heroku', 'AWS EC2'],
  ...
  },
  {
    ...
    technologies: ['React', 'Node.js', 'Express', 'PostgreSQL', 'Google Places API', 'Payment Integration', 'Email Notifications'],
